...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="text-gray-600 mb-4">"The rooms were spotless, staff was friendly and helpful. The breakfast was delicious with many options. Will definitely stay here again!"</p>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="text-gray-600 mb-4">"A truly luxurious experience. The suites are spacious and well-appointed. The staff went above and beyond to make our stay exceptional."</p>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="text-gray-600 mb-4">"Perfect location, amazing views, and the most comfortable beds I've ever slept in. The spa facilities were outstanding. Highly recommend!"</p>
